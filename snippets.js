...
// 	.end(function(result){
// 		var acceptableDish = ["main course", "salad", "breakfast", "soup", "dinner", "main dish", "lunch", "morning meal", "brunch", "breakfast"] 
// 		if(include.acceptableDish === true){
// 				var recipeInfo = {
...
var acceptableDish = ["main course", "salad", "breakfast", "soup", "dinner", "main dish", "lunch", "morning meal", "brunch", "breakfast"]
var dishType = result.body.recipes[0].dishTypes
isAcceptable = function(){
	for (var i = 0; i < acceptableDish.length; i++) {
		acceptableDish[i]
		if {
			acceptableDish.include(dishType)}
	}

} 
console.log("acceptableDish")
isAcceptable()
